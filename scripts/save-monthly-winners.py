#!/usr/bin/env python3
"""
Monthly Winners Save Script
This script saves the top 3 winners from a specific month to the monthlyWinners collection.
Run this at the end of each month to preserve the winners.
"""
...
# Month to save winners for (format: YYYY-MM)
# Leave empty to use current month
MONTH_TO_SAVE = ""  # e.g., "2025-08" or leave empty for current month
...
def main():
    """Main function."""
    print("🏆 Monthly Winners Save Script")
    print("=" * 50)
    
    # Determine which month to save
    month = MONTH_TO_SAVE if MONTH_TO_SAVE else get_current_month()
    ...
    response = input(f"\n❓ Do you want to save these winners for {month}? (y/N): ").strip().lower()
